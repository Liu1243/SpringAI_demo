...
import com.liu.springai_demo.entity.vo.Result;
import com.liu.springai_demo.repository.ChatHistoryRepository;
import com.liu.springai_demo.repository.FileRepository;
...
//                .advisors(a -> a.param(VectorStoreDocumentRetriever.FILTER_EXPRESSION, "file_name == '" + file.getFilename() + "'"))
                .stream()
                .content();
    }
