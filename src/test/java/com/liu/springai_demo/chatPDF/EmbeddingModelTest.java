...
import com.liu.springai_demo.utils.VectorDistanceUtils;
...
public class EmbeddingModelTest {
    ...
    @Test
    public void testEmbeddingModel() throws Exception {
    ...
    public void testEmbedding() {
        ...
        List<float[]> textVectors = model.embed(Arrays.asList(texts));
